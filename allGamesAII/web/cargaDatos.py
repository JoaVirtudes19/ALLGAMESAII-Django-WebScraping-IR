...
def crearJuegos(dicGeneros,generosTotales,plataformasTotales):
    print("CREAMOS LOS JUEGOS")
    Genero.objects.bulk_create(generosTotales)
    print("GENEROS CREADOS")
    Plataforma.objects.bulk_create(plataformasTotales)
    print("PLATAFORMAS CREADAS")
    Juego.objects.bulk_create(list(dicGeneros.keys()))
...
def instGaming(nombreIndice):
    ...
    try:
        ...
        for pag in range(1,2):
            ...
            for div in juegos:
                ...
                if plataformaDiv != None:
                    ...
                    plataforma = Plataforma(nombre=plataformaS)
                else:
                    plataformaS = "Indefinida"
                    plataforma  = Plataforma(nombre=plataformaS)
                plataformasTotales.add(plataforma)
                ...
                generosJuego = []
                for a in generos:
                    genero = Genero(nombre=str(a.string))
        ...
        crearJuegos(dicGeneros,generosTotales,plataformasTotales)
        wr.commit()
...
#Hacer función que reciba los datos y cre los objetos necesarios y los relacione.

#Función para crear las dos tiendas